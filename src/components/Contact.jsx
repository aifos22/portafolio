...
const Contact = () => {
  ...
  return (
    <section id="contact" className="fondo">
      <div className="container mx-auto">
        <div className="text-center mb-12 colortitulo">
          <h2 className="text-3xl md:text-4xl font-bold">Contáctame</h2>
          <div className="w-20 h-1 bg-secondary mx-auto mt-4 mb-6 colorlinea"></div>
          <p className="text-gray-600 max-w-2xl mx-auto">
            ¿Interesado/a en mi perfil? ¡Trabajemos juntos! Contáctame através de mis redes sociales
          </p>
        </div>

        <div className="max-w-4xl mx-auto glass-card p-8 md:p-12 fondo2">
          <div className="flex flex-col items-center space-y-6">
            <div className="text-center">
              <h3 className="text-xl font-semibold mb-4 colorletra4">Email</h3>
              <a
                href={`mailto:${contact.email}`}
                className="hover:underline flex items-center justify-center gap-2 colorletra3 font-bold"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
